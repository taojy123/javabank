...
//                }
        ...
        callback: function (editor, $w, url, state,name) {
            if (state == "SUCCESS") {
                //显示图片计数+1
                Upload.showCount++;
                var $img = $("<img src='" + editor.options.imagePath + name + "' class='edui-image-pic' />"),
    ...
    var Upload = {
        ...
        uploadComplete: function(r){
            ...
            try{
                ...
                Base.callback(me.editor, me.dialog, json.url, json.state,json.name);
            }catch (e){
